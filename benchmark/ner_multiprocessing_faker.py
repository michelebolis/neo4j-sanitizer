...
if __name__ == "__main__" :
    ...
    fakers = dict()
    for _, (_, entities, _) in sanitizer.models.items() :
        for entity in entities :
            fakers[entity] = lambda : "test"
    driver.close()
    ...
    sanitizer = Neo4jSanitizer(driver, context, context, context, context, batch_size = 10000)
    print()
    sanitizer.sanitization_ner_faker(fakers, blacklist=["id", "code", "date"], multiprocessing=True)
    driver.close()
