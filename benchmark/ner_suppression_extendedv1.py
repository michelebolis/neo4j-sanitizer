...
if __name__ == "__main__" :
    ...
    print(sanitizer.estimate_sanitizationNer(blacklist=["id", "code"]))
    driver.close()
    ...
    sanitizer = Neo4jSanitizer(driver, context, context, context, context, batch_size = 10000)
    print()
    sanitizer.sanitization_ner_suppression(blacklist=["id", "code"], multiprocessing=True)
    driver.close()

    end = time.perf_counter()
    print("Tempo: ",  end-start, "s") # 758.15 s